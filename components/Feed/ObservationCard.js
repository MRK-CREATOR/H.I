 ...
 * Displays an Observation post in the feed
 * 
 * @param {Object} props - Component props
 * @param {Object} props.data - Observation data
 * @param {Function} props.onPress - Function to handle post press
 */
const ObservationCard = ({ data, onPress }) => {
  // State
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          <View style={styles.postTypeTag}>
            <Text style={styles.postTypeText}>Observation</Text>
          </View>
      ...
      <View style={styles.footer}>
        <View style={styles.footerActions}>
          ...
          >
            <Icon
              name={liked ? 'eye' : 'eye-outline'}
              size={20}
              color={liked ? theme.colors.warning : theme.colors.textSecondary}
            />
            <Text
              style={[
                styles.actionText,
                liked && styles.actionTextWarning
              ]}
            >
              {expressionCount}
            </Text>
            ...
            <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
              <View style={styles.modalContent}>
                ...
                <TextInput
                  ...
                  placeholder="Share your perspective on this observation..."
